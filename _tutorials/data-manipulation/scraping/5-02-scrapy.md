...
我们之前有做过爬取 [易学习Python](/) 全网的信息. 用[多进程]({% link _tutorials/data-manipulation/scraping/4-01-distributed-scraping.md %})
...
一定还要给这个 spider 一个名字, 我就用 `mofan` 好了, 因为是爬 易学习Python 的.
